...
module level1_4 (
  ...
  wire [1-1:0] M_spike_red;
  wire [1-1:0] M_spike_green;
  wire [1-1:0] M_spike_blue;
  wire [1-1:0] M_spike_active;
  spike_11 spike (
    .clk(clk),
    .rst(rst),
    .x(x),
  ...
  always @* begin
    ...
    grid_input = 160'hfff780018001800180018001800180090ff0fff7;
    ...
    if (on) begin
      ...
      M_ball_reset = 1'h0;
      M_ball_on = 1'h1;
      fail = M_ball_active & M_spike_active;
      M_stars_d = M_stars_q;
      ...
      r = M_grid_red | M_ball_red | M_spike_red | star_r | star1_r | star2_r | expanding_square_r;
      g = M_grid_green | M_ball_green | M_spike_green | star_g | star1_g | star2_g | expanding_square_g;
      b = M_grid_blue | M_ball_blue | M_spike_blue | star_b | star1_b | star2_b | expanding_square_b;
    end else begin
      M_ball_on = 1'h0;
      r = 1'h0;
      g = 1'h0;
